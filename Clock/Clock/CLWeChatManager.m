...
#import "CLWeChatManager.h"

@implementation CLWeChatManager

+ (CLWeChatManager *)sharedManager
{
    static CLWeChatManager *sharedChatManagerInstance = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        sharedChatManagerInstance = [[CLWeChatManager alloc]init];
        [WXApi registerApp:@"wxd930ea5d5a258f4f" withDescription:@"demo 2.0"];
    });
    return sharedChatManagerInstance;
}
