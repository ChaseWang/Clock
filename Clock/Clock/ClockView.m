...
- (void) updateClock:(NSTimer *)theTimer{
    ...
    //pointView.layer.transform = CATransform3DMakeRotation (secAngle+M_PI, 0, 0, 1);
}
...
-(void)defaultSetup
{
    ...
    pointView = [[CLPointView alloc]init];
...
- (void) layoutSubviews
{
    ...
    pointView.layer.position = c;
    pointView.bounds = CGRectMake(0,0,20,100);
    [pointView setBackgroundColor:[UIColor yellowColor]];
    pointView.layer.anchorPoint = CGPointMake(0.5,0.0);
